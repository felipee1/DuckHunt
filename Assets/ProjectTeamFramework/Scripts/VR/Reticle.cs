...
namespace VRStandardAssets.Utils
{
    ...
    public class Reticle : MonoBehaviour
    {
        ...
        public float DistanceToCamera
        {
            get
            {
                return Vector3.Distance(Camera.main.transform.position,this.transform.position);
            }
        }
        ...
        public void SetPosition(RaycastHit hit, Vector3 worldStartPoint)
        {
            m_ReticleTransform.position = hit.point == Vector3.zero ? worldStartPoint : hit.point;
            //m_ReticleTransform.localScale = m_OriginalScale * hit.distance;
            m_ReticleTransform.localScale = m_OriginalScale * DistanceToCamera;
        ...
        // This overload of SetPosition is used when the VREyeRaycaster has hit something touchable.
        public void SetPosition(Vector3 position)
        {
            m_ReticleTransform.position = position;
