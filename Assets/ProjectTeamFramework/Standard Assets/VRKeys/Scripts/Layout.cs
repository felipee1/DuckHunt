...
namespace VRKeys {
	...
	/// </summary>
	public class Layout {
		public string placeholderMessage = "Digite o código SAP";

		public string spaceButtonLabel = "ESPAÇO";

		public string enterButtonLabel = "ENTRAR";

		public string cancelButtonLabel = "CANCELAR";

		public string shiftButtonLabel = "SHIFT";

		public string backspaceButtonLabel = "APAGAR";

		public string clearButtonLabel = "LIMPAR";
